  ...
  const handleFirstNameChange = (event) => {
    ...
    if (validateText(textValue)) {
      ...
      setFirstName({
        ...
        errorMessage:
          "Firstname should be greater or equal to two 2 characters",
        isFirstNameValidate: false,
      });
    }
  };
    ...
    <form className="space-y-2 w-full" noValidate={true}>
      ...
      <div className="flex flex-col gap-1 w-full">
        ...
        <input
          ...
          ref={firstNameRef}
          className="flex-grow px-2 py-2 text-xs placeholder:text-[10px] placeholder:text-black rounded-md border border-gray-400 focus:border-green-300"
          name="firstname"
          type="text"
        />
      ...
      <div className="flex flex-col gap-1 w-full">
        ...
        <input
          ...
          ref={passwordRef}
          className="w-full px-2 py-2 text-xs  placeholder:text-[10px] placeholder:text-black rounded-md border border-gray-400"
          name="password"
          type="password"
        />
        <p className="text-[8px] text-red-500 font-medium">
