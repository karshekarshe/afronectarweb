    ...
    return (
        <form className="space-y-4 w-full" noValidate={true}>
            ...
            <div className="flex flex-col gap-1 w-full">
                <label className="text-sm" htmlFor="email">{t('login_email_field_name')}</label>
                    ...
                    <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none ">
                        <svg width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <path
                                ...
                                stroke="" strokeWidth="1.5" strokeLinecap="round"></path>
                        </svg>
                    </div>
            ...
            <a className="text-sm md:text-base underline text-green-800"
            ...
            <div className="flex flex-row items-center justify-between gap-4">
                <button
                    ...
                    className="bg-green-600 capitalize w-1/2 flex flex-row items-center justify-center text-white px-1 py-3 text-sm md:text-base font-medium rounded-md disabled:bg-gray-200 disabled:text-black">
                    {loading ? <CircleAnimationIcon className="w-5"/> : t('login_button_name')}
                </button>
                <a className="flex-grow px-1 py-3 text-sm md:text-base font-medium text-white bg-amber-800 text-center rounded-md" href="/account/register">Create a new account</a>
            </div>
        </form>
    )
}
